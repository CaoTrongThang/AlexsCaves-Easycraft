...
public final class ClientHooks {
    ...
    public static ResourceLocation getArmorTexture(LivingEntity entity, ItemStack stack, Object layer, boolean innerModel, EquipmentSlot slot) {
        ...
        return ResourceLocation.fromNamespaceAndPath("minecraft", innerModel ? "textures/models/armor/diamond_layer_2.png" : "textures/models/armor/diamond_layer_1.png");
    }
}

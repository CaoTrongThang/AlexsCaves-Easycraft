...
public class RegistryCompat {
    ...
    public static <T> Optional<Holder.Reference<T>> getHolder(Registry<T> registry, ResourceKey<T> resourceKey) {
        return registry.get(resourceKey.location());
    }

    public static <T> Optional<Holder.Reference<T>> getHolder(Registry<T> registry, ResourceLocation resourceLocation) {
    ...
    public static <T> Holder.Reference<T> getHolderOrThrow(Registry<T> registry, ResourceLocation resourceLocation) {

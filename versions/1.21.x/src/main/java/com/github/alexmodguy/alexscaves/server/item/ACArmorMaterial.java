...
public class ACArmorMaterial {
    ...
    private ArmorMaterial createMaterial() {
        ...
        TagKey<Item> repairTag = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID, "repairs/" + this.name + "_armor"));
        ResourceKey<EquipmentAsset> assetId = ResourceKey.create(EquipmentAssets.ROOT_ID, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID, this.name));

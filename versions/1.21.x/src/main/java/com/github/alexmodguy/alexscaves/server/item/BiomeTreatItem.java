...
public class BiomeTreatItem extends CaveInfoItem {
    ...
    public void onUseTick(Level level, LivingEntity living, ItemStack stack, int useDir) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            serverLevel.sendParticles(new ItemParticleOption(ACParticleRegistry.JELLY_BEAN_EAT.get(), stack), vec31.x, vec31.y, vec31.z, 1, vec3.x, vec3.y + 0.05D, vec3.z, 0.0D);
        } else {

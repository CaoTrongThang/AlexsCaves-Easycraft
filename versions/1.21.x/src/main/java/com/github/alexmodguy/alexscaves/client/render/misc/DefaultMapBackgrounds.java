...
public enum DefaultMapBackgrounds {
    ...
    private static NativeImage getBackgroundTexture(int id, ResourceLocation resourceLocation) {
    ...
    public int getMapColor(int u, int v) {
        if (texture == null) {
            texture = ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID,
    ...
    private static NativeImage loadBackgroundTexture(ResourceLocation resourceLocation) {

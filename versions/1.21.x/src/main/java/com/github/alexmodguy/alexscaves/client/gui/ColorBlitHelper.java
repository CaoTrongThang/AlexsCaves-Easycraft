...
public class ColorBlitHelper {
    ...
    public static void blitWithColor(GuiGraphics guiGraphics, ResourceLocation texture, int x, int y, int width, int height,
                                     float r, float g, float b, float a) {
        GuiCompat.blit(guiGraphics, texture, x, y, 0, 0, width, height, 256, 256);
    }

    public static void blitWithColor(GuiGraphics guiGraphics, ResourceLocation texture, int x, int y, int z, float u, float v,

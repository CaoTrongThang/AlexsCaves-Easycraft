...
public class AmberMonolithBlockRenderer<T extends AmberMonolithBlockEntity> implements BlockEntityRenderer121X<T> {
    ...
    private static void renderCompatLivingModel(LivingEntity living, BasicEntityModel<?> baseModel, net.minecraft.resources.ResourceLocation texture,
    ...
    private static net.minecraft.resources.ResourceLocation getTextureLocation(LivingEntityRenderer121X<?, ?> renderer, LivingEntity entity) {

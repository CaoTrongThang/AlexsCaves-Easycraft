...
public class LicowitchPossessionLayer<T extends LivingEntity & PossessedByLicowitch, M extends AdvancedEntityModel<T>> extends RenderLayer121X<T, M> {
    ...
    public LicowitchPossessionLayer(RenderLayerParent121X<T, M> renderLayerParent, Function<T, ResourceLocation> replacementTexture) {
        super(renderLayerParent);
    }

    public LicowitchPossessionLayer(RenderLayerParent121X<T, M> renderLayerParent, AdvancedEntityModel<T> replacementModel, Function<T, ResourceLocation> replacementTexture) {
        super(renderLayerParent);
    }

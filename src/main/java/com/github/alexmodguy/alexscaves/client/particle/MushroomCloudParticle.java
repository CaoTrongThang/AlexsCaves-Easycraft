...
public class MushroomCloudParticle extends Particle {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/particle/mushroom_cloud.png");
    private static final ResourceLocation TEXTURE_GLOW = new ResourceLocation(AlexsCaves.MODID, "textures/particle/mushroom_cloud_glow.png");
    private static final ResourceLocation TEXTURE_PINK = new ResourceLocation(AlexsCaves.MODID, "textures/particle/mushroom_cloud_pink.png");
    private static final ResourceLocation TEXTURE_PINK_GLOW = new ResourceLocation(AlexsCaves.MODID, "textures/particle/mushroom_cloud_pink_glow.png");

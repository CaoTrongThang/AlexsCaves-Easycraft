...
public class RaycatRenderer extends MobRenderer<RaycatEntity, RaycatModel> implements CustomBookEntityRenderer {
    private static final ResourceLocation TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/raycat.png");
    private static final ResourceLocation TEXTURE_BODY = new ResourceLocation(AlexsCaves.MODID, "textures/entity/raycat_body.png");
    private static final ResourceLocation TEXTURE_EYES = new ResourceLocation(AlexsCaves.MODID, "textures/entity/raycat_eyes.png");

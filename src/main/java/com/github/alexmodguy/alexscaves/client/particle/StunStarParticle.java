...
public class StunStarParticle extends AbstractTrailParticle {
    ...
    private static final ResourceLocation CENTER_TEXTURE = new ResourceLocation(AlexsCaves.MODID,
            "textures/particle/stun_star.png");
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float partialTick) {
        ...
        VertexConsumer vertexconsumer = multibuffersource$buffersource
                .getBuffer(ACRenderTypes.itemEntityTranslucentCull(CENTER_TEXTURE));
    ...
    public Vec3 getOrbitPos() {
        ...
        if (entity != null) {
            ...
            if (entity instanceof SauropodBaseEntity sauropod) {
                ...
                eyes = entity.getEyePosition().add(entity.getViewVector(0.0F).scale(entity.getBbWidth() * 0.85F)).add(0,
                        0.5 + 0.12 * entity.getBbHeight(), 0);

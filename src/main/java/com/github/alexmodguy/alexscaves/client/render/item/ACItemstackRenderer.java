...
public class ACItemstackRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    private static final ResourceLocation GALENA_GAUNTLET_RED_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/galena_gauntlet_red.png");
    private static final ResourceLocation GALENA_GAUNTLET_BLUE_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/galena_gauntlet_blue.png");
    ...
    private static final ResourceLocation RESISTOR_SHIELD_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/resistor_shield.png");
    private static final ResourceLocation RESISTOR_SHIELD_RED_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/resistor_shield_red.png");
    private static final ResourceLocation RESISTOR_SHIELD_BLUE_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/resistor_shield_blue.png");
    private static final ResistorShieldModel RESISTOR_SHIELD_MODEL = new ResistorShieldModel();
    private static final ResourceLocation PRIMITIVE_CLUB_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/primitive_club.png");
    private static final PrimitiveClubModel PRIMITIVE_CLUB_MODEL = new PrimitiveClubModel();
    private static final ResourceLocation LIMESTONE_SPEAR_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/limestone_spear.png");
    private static final LimestoneSpearModel LIMESTONE_SPEAR_MODEL = new LimestoneSpearModel();
    private static final ResourceLocation EXTINCTION_SPEAR_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/extinction_spear.png");
    ...
    private static final ResourceLocation RAYGUN_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/raygun/raygun.png");
    private static final ResourceLocation RAYGUN_ACTIVE_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/raygun/raygun_active.png");
    private static final ResourceLocation RAYGUN_BLUE_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/raygun/raygun_blue.png");
    private static final ResourceLocation RAYGUN_BLUE_ACTIVE_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/raygun/raygun_blue_active.png");
    private static final RaygunModel RAYGUN_MODEL = new RaygunModel();
    private static final ResourceLocation SEA_STAFF_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/deep_one/sea_staff.png");
    private static final SeaStaffModel SEA_STAFF_MODEL = new SeaStaffModel();
    private static final ResourceLocation ORTHOLANCE_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/deep_one/ortholance.png");
    ...
    private static final ResourceLocation DREADBOW_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/dreadbow.png");
    private static final ResourceLocation DREADBOW_TEXTURE_EYE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/dreadbow_eye.png");
    private static final ResourceLocation DREADBOW_TEXTURE_EYE_PERFECT = new ResourceLocation(AlexsCaves.MODID, "textures/entity/dreadbow_eye_perfect.png");
    ...
    private static final ResourceLocation SHOT_GUM_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/shot_gum.png");
    private static final ResourceLocation SHOT_GUM_GLASS_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/shot_gum_glass.png");
    private static final ShotGumModel SHOT_GUM_MODEL = new ShotGumModel();
    private static final ResourceLocation SUGAR_STAFF_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/sugar_staff.png");
    private static final SugarStaffModel SUGAR_STAFF_MODEL = new SugarStaffModel();
    private static final ResourceLocation FROSTMINT_SPEAR_TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/frostmint_spear.png");
    ...
    public void renderByItem(ItemStack itemStackIn, ItemDisplayContext transformType, PoseStack poseStack, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        if (itemStackIn.is(ACItemRegistry.RAYGUN.get())) {
            ...
            boolean gamma = com.github.alexmodguy.alexscaves.fabric.ItemStackCompat.getEnchantmentLevel(itemStackIn, ACEnchantmentRegistry.GAMMA_RAY.get())  > 0;

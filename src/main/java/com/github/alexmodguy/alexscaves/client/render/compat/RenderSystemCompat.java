...
public class RenderSystemCompat {
    ...
    private static void invokeShaderTexture(Object texture) throws ReflectiveOperationException {
        Object textureView = texture instanceof ResourceLocation resourceLocation ? resolveTextureView(resourceLocation) : texture;
    ...
    private static Object resolveTextureView(ResourceLocation resourceLocation) throws ReflectiveOperationException {
        Object textureManager = Minecraft.getInstance().getTextureManager();
        Method getTexture = textureManager.getClass().getMethod("getTexture", ResourceLocation.class);

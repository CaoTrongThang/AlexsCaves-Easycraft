...
public class AmbersolBlockRenderer<T extends AmbersolBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public static void renderEntireBatch(LevelRenderer levelRenderer, PoseStack poseStack, int renderTick,
    ...
    @Override
    public void render(T ambersol, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn,
    ...
    private static void renderAt(AmbersolBlockEntity ambersol, float partialTicks, PoseStack matrixStackIn,
        ...
        if (scale > 0.0F) {
            ...
            // minecrafts janky render system wont do transparent blocks unless you render a
            // selection box behind it.
            PoseStack.Pose posestack$pose = matrixStackIn.last();
            Matrix4f matrix4f = posestack$pose.pose();
            Matrix3f matrix3f = posestack$pose.normal();
    ...
    private static void shineOriginVertex(VertexConsumer p_114220_, Matrix4f p_114221_, Matrix3f p_114092_,
        ...
        p_114220_.vertex(p_114221_, 0.0F, 0.0F, 0.0F).color(SHINE_CENTER_R, SHINE_CENTER_G, SHINE_CENTER_B, 230)
                .uv(xOffset + 0.5F, yOffset).overlayCoords(NO_OVERLAY).uv2(240).normal(p_114092_, 0.0F, 1.0F, 0.0F)
                .endVertex();
    }
    ...
    private static void shineLeftCornerVertex(VertexConsumer p_114215_, Matrix4f p_114216_, Matrix3f p_114092_,
        ...
        p_114215_.vertex(p_114216_, -HALF_SQRT_3 * p_114218_, p_114217_, 0).color(SHINE_R, SHINE_G, SHINE_B, 0)
    ...
    private static void shineRightCornerVertex(VertexConsumer p_114224_, Matrix4f p_114225_, Matrix3f p_114092_,
        ...
        p_114224_.vertex(p_114225_, HALF_SQRT_3 * p_114227_, p_114226_, 0).color(SHINE_R, SHINE_G, SHINE_B, 0)

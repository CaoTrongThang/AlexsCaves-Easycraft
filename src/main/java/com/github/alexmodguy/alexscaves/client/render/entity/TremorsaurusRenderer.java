...
public class TremorsaurusRenderer extends MobRenderer<TremorsaurusEntity, TremorsaurusModel> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/tremorsaurus.png");
    private static final ResourceLocation TEXTURE_PRINCESS = new ResourceLocation(AlexsCaves.MODID, "textures/entity/tremorsaurus_princess.png");
    private static final ResourceLocation TEXTURE_RETRO = new ResourceLocation(AlexsCaves.MODID, "textures/entity/tremorsaurus_retro.png");
    private static final ResourceLocation TEXTURE_TECTONIC = new ResourceLocation(AlexsCaves.MODID, "textures/entity/tremorsaurus_tectonic.png");

...
public class ForsakenRenderer extends MobRenderer<ForsakenEntity, ForsakenModel> {
    ...
    private static final ResourceLocation TEXTURE_EYES = new ResourceLocation(AlexsCaves.MODID, "textures/entity/forsaken_eyes.png");

    private static final ResourceLocation TEXTURE_DARKNESS = new ResourceLocation(AlexsCaves.MODID, "textures/entity/forsaken_darkness.png");

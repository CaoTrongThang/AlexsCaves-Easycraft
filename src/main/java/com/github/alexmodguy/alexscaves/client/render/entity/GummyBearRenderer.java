...
public class GummyBearRenderer extends MobRenderer<GummyBearEntity, GummyBearModel> implements CustomBookEntityRenderer {
    ...
    private static final ResourceLocation TEXTURE_RED = new ResourceLocation(AlexsCaves.MODID, "textures/entity/gummy_bear_red.png");
    private static final ResourceLocation TEXTURE_GREEN = new ResourceLocation(AlexsCaves.MODID, "textures/entity/gummy_bear_green.png");
    private static final ResourceLocation TEXTURE_YELLOW = new ResourceLocation(AlexsCaves.MODID, "textures/entity/gummy_bear_yellow.png");
    private static final ResourceLocation TEXTURE_BLUE = new ResourceLocation(AlexsCaves.MODID, "textures/entity/gummy_bear_blue.png");
    private static final ResourceLocation TEXTURE_PINK = new ResourceLocation(AlexsCaves.MODID, "textures/entity/gummy_bear_pink.png");
    private static final ResourceLocation TEXTURE_INNARDS = new ResourceLocation(AlexsCaves.MODID, "textures/entity/gummy_bear_innards.png");

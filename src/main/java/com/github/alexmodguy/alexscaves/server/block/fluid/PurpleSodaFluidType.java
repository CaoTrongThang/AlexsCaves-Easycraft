...
public class PurpleSodaFluidType extends FluidType {
    ...
    public static final ResourceLocation FLUID_STILL = new ResourceLocation(AlexsCaves.MODID, "block/purple_soda_still");
    public static final ResourceLocation FLUID_FLOWING = new ResourceLocation(AlexsCaves.MODID, "block/purple_soda_flowing");
    public static final ResourceLocation OVERLAY = new ResourceLocation(AlexsCaves.MODID, "textures/misc/under_purple_soda.png");

...
public class ACEntityDataRegistry {
    ...
    public static final DeferredRegister<EntityDataSerializer<?>> DEF_REG = DeferredRegister.create((net.minecraft.resources.ResourceKey) ForgeRegistries.Keys.ENTITY_DATA_SERIALIZERS, AlexsCaves.MODID);

...
public class ACEntityDataRegistry {
    ...
    private static boolean fabricSerializersRegistered = false;
    ...
    public static void registerFabricSerializers() {
        if (fabricSerializersRegistered) {
            return;
        }
        fabricSerializersRegistered = true;
        EntityDataSerializers.registerSerializer(OPTIONAL_VEC_3.get());
        EntityDataSerializers.registerSerializer(GUMMY_COLOR.get());
    }

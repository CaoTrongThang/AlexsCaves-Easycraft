...
public abstract class ForgeFlowingFluid extends BaseFlowingFluid {
    ...
    public static class Properties extends BaseFlowingFluid.Properties {
        ...
        public Properties(com.github.alexmodguy.alexscaves.forge_shim.registries.DeferredHolder<? extends FluidType, ? extends FluidType> type, com.github.alexmodguy.alexscaves.forge_shim.registries.DeferredHolder<? extends net.minecraft.world.level.material.Fluid, ? extends net.minecraft.world.level.material.Fluid> source, com.github.alexmodguy.alexscaves.forge_shim.registries.DeferredHolder<? extends net.minecraft.world.level.material.Fluid, ? extends net.minecraft.world.level.material.Fluid> flowing) {
            super(type, source, flowing);
        }
